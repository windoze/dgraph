...
type ZeroClient interface {
	ShouldServe(ctx context.Context, in *Tablet, opts ...grpc.CallOption) (*Payload, error)
...
func (c *zeroClient) ShouldServe(ctx context.Context, in *Tablet, opts ...grpc.CallOption) (*Payload, error) {
	out := new(Payload)
...
type ZeroServer interface {
	ShouldServe(context.Context, *Tablet) (*Payload, error)
...
var fileDescriptorPayload = []byte{
	...
	,
}
