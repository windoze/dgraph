...
type ZeroClient interface {
	...
	ShouldServe(ctx context.Context, in *MembershipQuery, opts ...grpc.CallOption) (*Payload, error)
	Update(ctx context.Context, in *Membership, opts ...grpc.CallOption) (*MembershipUpdate, error)
}
...
func (c *zeroClient) ShouldServe(ctx context.Context, in *MembershipQuery, opts ...grpc.CallOption) (*Payload, error) {
	out := new(Payload)
...
func (c *zeroClient) Update(ctx context.Context, in *Membership, opts ...grpc.CallOption) (*MembershipUpdate, error) {
	out := new(MembershipUpdate)
...
type ZeroServer interface {
	...
	ShouldServe(context.Context, *MembershipQuery) (*Payload, error)
	Update(context.Context, *Membership) (*MembershipUpdate, error)
}
...
func _Zero_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZeroServer).Update(ctx, req.(*Membership))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorPayload = []byte{
	...
	,
}
