...
type SrcFunction struct {
	...
	// TODO: Try to use the lang in query, avoid this.
...
func (m *SrcFunction) GetLang() string {
	if m != nil {
		return m.Lang
	}
	return ""
...
func (*SortMessage) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{6} }
...
func (*SortResult) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{7} }
...
var fileDescriptorTask = []byte{
	...
	,
}
