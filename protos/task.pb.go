...
type Tablet struct {
	...
	UidStart  uint64 `protobuf:"varint,3,opt,name=uid_start,json=uidStart,proto3" json:"uid_start,omitempty"`
	UidEnd    uint64 `protobuf:"varint,4,opt,name=uid_end,json=uidEnd,proto3" json:"uid_end,omitempty"`
...
func (m *Tablet) GetUidStart() uint64 {
	if m != nil {
		return m.UidStart
	}
	return 0
...
func (m *Tablet) GetUidEnd() uint64 {
	if m != nil {
		return m.UidEnd
	}
	return 0
...
func (m *Tablet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UidStart != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.UidStart))
	}
	if m.UidEnd != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.UidEnd))
	}
	if m.Size_ != 0 {
		dAtA[i] = 0x28
		i++
...
func (m *Tablet) Size() (n int) {
	...
	if m.UidStart != 0 {
		n += 1 + sovTask(uint64(m.UidStart))
	}
	if m.UidEnd != 0 {
		n += 1 + sovTask(uint64(m.UidEnd))
	}
	if m.Size_ != 0 {
...
func (m *Tablet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UidStart", wireType)
			}
			m.UidStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UidStart |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UidEnd", wireType)
			}
			m.UidEnd = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorTask = []byte{
	...
	,
}
